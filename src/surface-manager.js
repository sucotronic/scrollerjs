...
(function (w) {
    ...
    SurfaceManager.prototype = {
        ...
        _dettachItemInSurface: function (surface) {
            ...
            surface.width        = null;
            surface.offset       = null;
           //console.log(surface.dom.innerHTML); 
           //console.log(document.getElementsByClassName("scroller")[0].children.length);
        ...
        _positionedSurfacesPush: function (boundaries) {
            ...
            if (!bottomSurface)
            {
                ...
                {
                    console.log(this.items[i].offset);
        ...
        // Recibe "top" o "bottom" y comprueba si el index del primero en el array
        // positioned es mayor que cero, o el último en positioned es menor que 1
        // significando que hay mas elementos 
        ...
        _updateSurfaceManager: function () {
            ...
            if (current.dist < 0) {
                ...
                while (!bottomSurface || (this._itemsLeft('bottom') && bottomSurfaceEnd < boundaries.bottom && 
                        !inUse)) {
                    surface = this._positionedSurfacesPush(boundaries);
                    if (surface === bottomSurface) {
                        // significa que habríamos llegado a otro en uso (infinite loop?)
                        inUse = true;
                    } else {
            ...
            // User is Scrolling up/left
                ...
                // si no hay topSurface, se debería de coger un surface cuyo offset
                // esté en el boundaries
